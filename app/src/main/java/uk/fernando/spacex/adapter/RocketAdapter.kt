package uk.fernando.spacex.adapter
...
import uk.fernando.spacex.databinding.ItemRocketBinding
import uk.fernando.spacex.extension.TAG
        ...
        fun bind(rocket: RocketModel) {
            try {
                ...
                itemView.setOnClickListener {
                    itemClickListener.onItemClickListener(rocket)
                }
